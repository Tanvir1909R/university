...
exports.updateDepartment = exports.deleteDepartment = exports.findDepartment = exports.createDepartment = void 0;
...
const createDepartment = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
        const result = yield department_schema_1.default.create(data);
...
const findDepartment = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        //search
        ...
        const result = yield department_schema_1.default.find(findCondition).populate('faculty').sort(sortOrderFaculty).skip(skip).limit(limit);
        res.status(http_status_1.OK).json({
            success: true,
...
const deleteDepartment = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield department_schema_1.default.findOneAndDelete({ _id: id }, req.body);
        res.status(http_status_1.OK).json({
            success: true,
...
const updateDepartment = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        const result = yield department_schema_1.default.findOneAndUpdate({ _id: id }, req.body, { new: true });
        res.status(http_status_1.OK).json({
            success: true,
