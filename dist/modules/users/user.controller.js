...
exports.createAdmin = exports.createFaculty = exports.createsStudent = void 0;
...
const createAdmin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        try {
            session.startTransaction();
            const generateId = yield (0, user_utils_1.generateAdminId)();
            user.id = generateId;
            admin.id = generateId;
            const newAdmin = yield admin_schema_1.Admin.create([admin], { session });
            if (!newAdmin.length) {
                throw new apiError_1.default(http_status_1.default.BAD_REQUEST, 'fail to create faculty');
            }
